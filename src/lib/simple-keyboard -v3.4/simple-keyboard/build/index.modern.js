/*!
 * 
 *   simple-keyboard v3.4.100 (index.modern.js - Modern Browsers bundle)
    ...
    return function () {
        ...
        var u = function () {
            function t(e) {
                var n = e.getOptions,
                    ...
                    i = e.getCaretPositionEnd,
                    s = e.dispatch;
                ! function (t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), r(this, "getOptions", void 0), r(this, "getCaretPosition", void 0), r(this, "getCaretPositionEnd", void 0), r(this, "dispatch", void 0), r(this, "maxLengthReached", void 0), r(this, "isStandardButton", (function (t) {
                    return t && !("{" === t[0] && "}" === t[t.length - 1])
                })), this.getOptions = n, this.getCaretPosition = o, this.getCaretPositionEnd = i, this.dispatch = s, t.bindMethods(t, this)
            }
            var e, i, u;
            return e = t, u = [{
                key: "bindMethods",
                value: function (t, e) {
                    ...
                    try {
                        for (i.s(); !(n = i.n()).done;) {
                            var s = n.value;
                            "constructor" === s || "bindMethods" === s || (e[s] = e[s].bind(e))
                        }
                    } catch (t) {
                        i.e(t)
                    } finally {
                ...
                value: function (t) {
                    ...
                    if (n === o) {
                        var s = /([\uD800-\uDBFF][\uDC00-\uDFFF])/g,
                            a = t.substring(n, n + 2),
                            r = a.match(s);
                        e = r ? t.substr(0, n) + t.substr(n + 2) : t.substr(0, n) + t.substr(n + 1)
                    } else e = t.slice(0, n) + t.slice(o), i && this.dispatch((function (t) {
                        t.setCaretPosition(n)
                    }));
                    return e
                ...
                value: function (t, e) {
                    ...
                    if ("object" === s(o)) {
                        var r = e.length - 1 >= o[n.inputName || "default"];
                        return n.debug && console.log("maxLength (obj) reached:", r), r ? (this.maxLengthReached = !0, !0) : (this.maxLengthReached = !1, !1)
                    }
                }
            }, {
                ...
                key: "chunkArray",
                value: function (t, e) {
                    return n(Array(Math.ceil(t.length / e))).map((function (n, o) {
                        return t.slice(e * o, e + e * o)
                    }))
                }
            }]) && a(e.prototype, i), u && a(e, u), Object.defineProperty(e, "prototype", {
                writable: !1
            }), t
        }();
        r(u, "noop", (function () { }));
        ...
        var h = function () {
            function t(e) {
                ...
                ! function (t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), d(this, "getOptions", void 0), d(this, "dispatch", void 0), this.dispatch = n, this.getOptions = o, l.bindMethods(t, this)
            }
            var e, n, o;
            return e = t, (n = [{
                ...
                value: function (t) {
                    ...
                    this.dispatch((function (o) {
                        var i, s, a = o.getButtonElement(n),
                            r = o.getButtonElement("{".concat(n, "}"));
                        if (a) i = a, s = n;
                        else {
                            if (!r) return;
                            i = r, s = "{".concat(n, "}")
                        }
                        i && (i.style.backgroundColor = e.physicalKeyboardHighlightBgColor || "#dadce4", i.style.color = e.physicalKeyboardHighlightTextColor || "black", e.physicalKeyboardHighlightPress && (e.physicalKeyboardHighlightPressUsePointerEvents ? i.onpointerdown() : e.physicalKeyboardHighlightPressUseClick ? i.click() : o.handleButtonClicked(s, t)))
                    }))
                }
            }, {
        ...
        var y = function () {
            function t(e) {
                ...
                ! function (t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), f(this, "utilities", void 0), f(this, "candidateBoxElement", void 0), f(this, "pageIndex", 0), f(this, "pageSize", void 0), this.utilities = n, l.bindMethods(t, this), this.pageSize = this.utilities.getOptions().layoutCandidatesPageSize || 5
            }
            var e, n, o;
            return e = t, (n = [{
                key: "destroy",
                ...
                value: function (t) {
                    var e = this,
                        ...
                        i = t.onSelect;
                    if (n && n.length) {
                        var s = this.utilities.chunkArray(n.split(" "), this.pageSize);
                        this.renderPage({
                            candidateListPages: s,
                            targetElement: o,
                ...
                value: function (t) {
                    ...
                    u.className = "hg-candidate-box-list", o[s].forEach((function (t) {
                    ...
                    c.classList.add("hg-candidate-box-prev"), l && c.classList.add("hg-candidate-box-btn-active"), c.onclick = function () {
                        l && n.renderPage({
                    ...
                    }, this.candidateBoxElement.appendChild(c), this.candidateBoxElement.appendChild(u);
                    var d = s < a - 1,
                        h = document.createElement("div");
                    h.classList.add("hg-candidate-box-next"), d && h.classList.add("hg-candidate-box-btn-active"), h.onclick = function () {
                        d && n.renderPage({
                            candidateListPages: o,
                            targetElement: i,
                            pageIndex: s + 1,
                    ...
                    }, this.candidateBoxElement.appendChild(h), i.prepend(this.candidateBoxElement)
                }
        ...
        var E = function () {
            function t(e, n) {
                ...
                if (function (t, e) {
                    ...
                    var n, o, i;
                    if ("string" == typeof t) n = t.split(".").join(""), o = document.querySelector(".".concat(n)), i = e;
                    ...
                    } else n = "simple-keyboard", o = document.querySelector(".".concat(n)), i = t;
                    return {
                        keyboardDOMClass: n,
                        keyboardDOM: o,
                        options: i
                    ...
                    var i = [o.keyboardDOMClass].concat(e).filter((function (t) {
                        return !!t
                    }));
                    return i.join(" ")
                    ...
                    var c = this.options.inputName,
                        d = void 0 === c ? this.defaultName : c;
                    if (this.input = {}, this.input[d] = "", this.keyboardDOMClass = s, this.buttonElements = {}, window.SimpleKeyboardInstances || (window.SimpleKeyboardInstances = {}), this.currentInstanceName = this.utilities.camelCase(this.keyboardDOMClass), window.SimpleKeyboardInstances[this.currentInstanceName] = this, this.allKeyboardInstances = window.SimpleKeyboardInstances, this.keyboardInstanceNames = Object.keys(window.SimpleKeyboardInstances), this.isFirstKeyboardInstance = this.keyboardInstanceNames[0] === this.currentInstanceName, this.physicalKeyboard = new h({
                        dispatch: this.dispatch,
                        getOptions: this.getOptions
                    }), this.candidateBox = this.options.enableLayoutCandidates ? new y({
                        utilities: this.utilities
                    }) : null, !this.keyboardDOM) throw console.warn('".'.concat(s, '" was not found in the DOM.')), new Error("KEYBOARD_DOM_ERROR");
            ...
            return e = t, (n = [{
                ...
                value: function (t) {
                    ...
                    if (!o || "object" !== v(o)) return {};
                    var s = Object.keys(o).filter((function (n) {
                        var o = t.substring(0, e.getCaretPositionEnd() || 0) || t,
                            s = new RegExp("".concat(n, "$"), i ? "g" : "gi");
                        return !!g(o.matchAll(s)).length
                    }));
                    if (s.length > 1) {
                ...
                value: function (t, e, n) {
                    ...
                    this.candidateBox && this.candidateBox.show({
                        ...
                        onSelect: function (e, n) {
                            var i = o.options.layoutCandidatesCaseSensitiveMatch,
                                s = e.normalize("NFD"),
                                a = o.getInput(o.options.inputName, !0),
                                r = o.getCaretPositionEnd() || 0,
                                u = a.substring(0, r || 0) || a,
                                l = new RegExp("".concat(t, "$"), i ? "g" : "gi"),
                                c = u.replace(l, s),
                                d = a.replace(u, c),
                                h = c.length - u.length,
                                p = (r || a.length) + h;
                            p < 0 && (p = 0), o.setInput(d, o.options.inputName, !0), o.setCaretPosition(p), "function" == typeof o.options.onChange && o.options.onChange(o.getInput(o.options.inputName, !0), n), "function" == typeof o.options.onChangeAll && o.options.onChangeAll(o.getAllInputs(), n)
                        }
                    })
                }
            }, {
                ...
                value: function (t, e) {
                    ...
                    if ("{//}" !== t) {
                        ...
                        var a = this.utilities.getUpdatedInput(t, this.input[i], this.caretPosition, this.caretPositionEnd);
                        if (this.utilities.isStandardButton(t) && this.activeInputElement && this.input[i] && this.input[i] === a && 0 === this.caretPosition && this.caretPositionEnd === a.length) return this.setInput("", this.options.inputName, !0), this.setCaretPosition(0), this.activeInputElement.value = "", this.activeInputElement.setSelectionRange(0, 0), void this.handleButtonClicked(t, e);
                        if ("function" == typeof this.options.onKeyPress && this.options.onKeyPress(t, e), this.input[i] !== a && (!this.options.inputPattern || this.options.inputPattern && this.inputPatternIsValid(a))) {
                            if (this.options.maxLength && this.utilities.handleMaxLength(this.input, a)) return;
                            var r = this.utilities.getUpdatedInput(t, this.input[i], this.caretPosition, this.caretPositionEnd, !0);
                            if (this.setInput(r, this.options.inputName, !0), s && console.log("Input changed:", this.getAllInputs()), this.options.debug && console.log("Caret at: ", this.getCaretPosition(), this.getCaretPositionEnd(), "(".concat(this.keyboardDOMClass, ")")), this.options.syncInstanceInputs && this.syncInstanceInputs(), "function" == typeof this.options.onChange && this.options.onChange(this.getInput(this.options.inputName, !0), e), "function" == typeof this.options.onChangeAll && this.options.onChangeAll(this.getAllInputs(), e), null != e && e.target && this.options.enableLayoutCandidates) {
                                var u, l = this.getInputCandidates(a),
                                    c = l.candidateKey,
                                    d = l.candidateValue;
                                c && d ? this.showCandidatesBox(c, d, this.keyboardDOM) : null === (u = this.candidateBox) || void 0 === u || u.destroy()
                            }
                        }
                        s && console.log("Key pressed:", t)
                    }
                }
            }, {
                key: "getMouseHold",
            ...
            },
            {
                ...
                value: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
                    t.includes("layoutName") && this.candidateBox && this.candidateBox.destroy(), (t.includes("layoutCandidatesPageSize") || t.includes("layoutCandidates")) && this.candidateBox && (this.candidateBox.destroy(), this.candidateBox = new y({
                        utilities: this.utilities
                    }))
                }
            }, {
                ...
                value: function (t, e) {
                    ...
                    t && Array.isArray(this.options.buttonTheme) && this.options.buttonTheme.length && (t.split(" ").forEach((function (t) {
                        var o, i;
                        null === (o = n.options) || void 0 === o || null === (i = o.buttonTheme) || void 0 === i || i.map((function (o, i) {
                            if (o && e && e.includes(o.class) || !e) {
                                var s, a, r = null === (s = o) || void 0 === s ? void 0 : s.buttons.split(" ").filter((function (e) {
                                    return e !== t
                                }));
                                o && null != r && r.length ? o.buttons = r.join(" ") : (null === (a = n.options.buttonTheme) || void 0 === a || a.splice(i, 1), o = null)
                            }
                            return o
                        }))
                    })), this.render())
                ...
                value: function (t) {
                    ...
                    t.target.tagName && (e = t.target.tagName.toLowerCase()), this.dispatch((function (o) {
                        var i = t.target === o.keyboardDOM || t.target && o.keyboardDOM.contains(t.target);
                ...
                value: function (t, e, n, o) {
                    ...
                    return s.length && n.forEach((function (n, r) {
                        ...
                        var h = "".concat(i.options.layoutName, "-r").concat(e, "c").concat(r);
                        d.setAttribute("data-skUID", h);
                        var p = s.splice(l, c - l + 1);
                        a = c - l, p.forEach((function (t) {
                            return d.appendChild(t)
                        })), s.splice(l, 0, d), t.innerHTML = "", s.forEach((function (e) {
                            return t.appendChild(e)
                        })), i.options.debug && console.log("rowDOMContainer", p, l, c, a + 1)
                    })), t
                }
            }, {
                key: "render",
                value: function () {
                    ...
                    this.keyboardDOM.className = this.getKeyboardClassString(this.options.theme, e, this.keyboardPluginClasses, i), this.keyboardRowsDOM = document.createElement("div"), this.keyboardRowsDOM.className = "hg-rows", n[this.options.layoutName || this.defaultName].forEach((function (e, n) {
                        var i = e.split(" ");
                        t.options.excludeFromLayout && t.options.excludeFromLayout[t.options.layoutName || t.defaultName] && (i = i.filter((function (e) {
                        ...
                        i.forEach((function (e, i) {
                            var c, d = !a && "string" == typeof e && e.length > 1 && 0 === e.indexOf("["),
                                h = !a && "string" == typeof e && e.length > 1 && e.indexOf("]") === e.length - 1;
                            d && (u.push(i), e = e.replace(/\[/g, "")), h && (l.push(i), e = e.replace(/\]/g, ""));
                            ...
                            m.className += "hg-button ".concat(p), (c = m.classList).add.apply(c, g(t.getButtonThemeClasses(e))), t.setDOMButtonAttributes(e, (function (t, e) {
                                m.setAttribute(t, e)
                            })), t.activeButtonClass = "hg-activeButton", !t.utilities.pointerEventsSupported() || o || s ? o ? (m.ontouchstart = function (n) {
                            ...
                            b.innerHTML = f, m.appendChild(b), t.buttonElements[e] || (t.buttonElements[e] = []), t.buttonElements[e].push(m), r.appendChild(m)
                        })), r = t.parseRowDOMContainers(r, n, u, l), t.keyboardRowsDOM.appendChild(r)
                    })), this.keyboardDOM.appendChild(this.keyboardRowsDOM), this.onRender(), this.initialized || (this.initialized = !0, !this.utilities.pointerEventsSupported() || o || s ? o ? (document.ontouchend = function (e) {
